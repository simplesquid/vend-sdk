...
class ChannelRequestLogManager
{
     ...
     * @param  Carbon|null  $occurred_before     Limit requests to before this RFC3339 date.
     * @param  Carbon|null  $occurred_after      Limit requests to after this RFC3339 date.
    ...
    public function get(
        ...
        Carbon $occurred_before = null,
        Carbon $occurred_after = null,
